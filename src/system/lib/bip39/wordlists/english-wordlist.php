...
class BIP39EnglishWordList extends BIP39WordList
{
    ...
    {
        if (!isset($this->words)) {
            add_message("error", __CLASS__ . " does not contain a word for index [{$idx}]");
            return false;
        }
    ...
    public function getIndex($word)
    {
        ...
        if (!isset($this->words) || !isset($this->wordsFlipped[$word])) {
            add_message("error", __CLASS__ . " does not contain a word for index [{$word}]");
            return false;
        }
