...
{
    internal class MessageReceiverReadTest : ISkylessSkyTest
    {
        public string Name => "MESSAGE_RECEIVER_READ_TEST";
        ...
        public bool Run(string uri, ref Dictionary<string, string> bag)
        {
            try
            {
                ...
                dynamic res = Program.JSONRequest(HttpMethod.Get, uri + "/messages/receiver/" + bag["message_id"], data);
