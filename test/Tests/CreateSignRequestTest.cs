...
{
    internal class CreateSignRequestTest : ISkylessSkyTest
    {
        public string Name => "CREATE_SIGN_REQUEST_TEST";
            ...
            var data = new
                {
                    ...
                    message = "Please, authorize login at foobar.com...",
                    expires = 3600
                };
                
                dynamic res = Program.JSONRequest(HttpMethod.Post, uri + "/sign", data);
                ...
                bag.Add("contract_id", res.response.id.ToString());
